...
\titlerunning{Hypebeast}%optional, please use if title is longer than one line
...
\keywords{Hypertree decomposition, Hypertree width, Heuristic solver}%TODO mandatory; please add comma-separated list of keywords
...
\supplement{Source code DOI: \url{https://doi.org/10.5281/zenodo.3082314}; Source repository: \url{https://github.com/jamestrimble/hypebeast}}%optional, e.g. related research data, source code, ... hosted on a repository like zenodo, figshare, GitHub, ...
